<template>
  <div id="backgroundW" class="d-flex align-items-center">
    ...
    >
      <div
        class="col-4 d-flex flex-column align-items-center justify-content-around pt-2"
      >
        <picture>
      ...
      <div class="col-7">
        <picture>
          <source
            type="image/webp"
            srcset="../assets/compressed/foto_capa.webp"
          />
  ...
  methods: {
    ...
    register() {
      ...
      this.register_ap(this.form)
        .then(() => {
          (this.formLogin.username = this.form.username),
